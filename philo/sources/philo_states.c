...
/*   Updated: 2023/05/09 18:43:42 by fkoolhov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_philo_state_message(t_philo *philo)
{
	char		*state;
...
void	state_sleep(t_philo *philo)
{
	...
	print_philo_state_message(philo);
	let_time_pass(philo->data->time_to_sleep);
}
